...
override fun call(method: String, uri: String?, extras: Bundle?): Bundle {
    ...
    val summary = when (method) {
        MotoActionsSettings.MODEL_NUMBER_KEY -> MotoActionsSettings.getModelNumberString(ctx)
        MotoActionsSettings.CARRIER_KEY -> MotoActionsSettings.getCarrierString(ctx)
